...
{
    public static class SendTrainingDataTask extends AsyncTask<Void, Void, Void>
    {
        private Context context;
        private Double distance;
        private Integer id, finished, seconds, calories, discipline;
        private String encodedLatLngList, encodedGeoPoints, actualDate;

        private String url_training = "http://rower.lowicz.com.pl/BicycleTracker%20www/mobile_training.php";


        SendTrainingDataTask(Context context, int seconds, double distance, int calories, String encodedLatLngList,
                             String encodedGeoPoints, int finished)
        {
        ...
        {
            actualDate = SummaryActivity.getActualDate();
        ...
        protected Void doInBackground(Void... params)
        {
            ...
            try
            {
                String data = URLEncoder.encode("id", "UTF-8")+"="+URLEncoder.encode(id.toString(), "UTF-8")+"&"+
                        ...
                        URLEncoder.encode("date", "UTF-8")+"="+URLEncoder.encode(actualDate, "UTF-8")+"&"+
